lo- 👋 Hi, I’m @lluviaecosustentable
- 👀 I’m interested in ...
...
ver video 1 aqui "to watch video one here, Siistema autonomo de recolección de agua lluvia1_280x500_20250402180633.mp4 " 
ver video dos  aqui" to watch video two here, Siistema autonomo de recolección de agua lluvia2_280x500.mp4 "
---
...
*2. Tubería Principal (3 pulgadas)*:
   - *Función*: Transporta el agua desde el tejado hacia el sistema de filtración.
   - *Importancia*: Este diámetro es esencial para manejar volúmenes grandes durante lluvias intensas.

*3. Reductor (3x2 pulgadas)*:
   - *Función*: Regula el flujo de agua y dirige la presión inversa hacia los puntos superiores.
   - *Importancia*: Previene el rebose y asegura un flujo constante hacia el filtro.

*4. Tubería Secundaria (2 pulgadas)*:
   - *Función*: Conecta el reductor con el sistema de filtración y el tanque principal.
   - *Importancia*: También sirve como válvula de escape para el exceso de presión.

*5. Filtro Purificador*:
   - *Componentes*: 
      - Malla para partículas grandes.
      - Esponja para absorber impurezas menores.
      - Piedras de carbón para mejorar la calidad del agua.
